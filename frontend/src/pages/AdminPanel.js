        ...
        <aside className='bg-slate-100 w-full max-w-60 customShadow'>
            ...
            <div>
                <nav className='p-4 grid gap-1'>
                    ...
                    <NavLink to='all-products' className={({ isActive }) =>`px-2 py-1 text-lg hover:bg-slate-200 ${isActive ? 'bg-slate-200 font-semibold' : ''}`}>All Products</NavLink>
                    <NavLink to='all-orders' className={({ isActive }) =>`px-2 py-1 text-lg hover:bg-slate-200 ${isActive ? 'bg-slate-200 font-semibold' : ''}`}>All Orders</NavLink>
                </nav>
            </div>
        </aside>
